...
So the next steps are to get a multimeter and check Pin B7 on any ISA slot (or the -12V pin on the PSU connector) to ensure you actually have -12V. If that is working, then I likely need to buy a new card.
